...
cfg.DATA_LIST_SOURCE = str(project_root / 'advent/dataset/visible_list/{}.txt')
cfg.DATA_LIST_TARGET = str(project_root / 'advent/dataset/infrared_list/{}.txt')
# Directories
cfg.DATA_DIRECTORY_SOURCE = str(project_root / 'data/Visible')
cfg.DATA_DIRECTORY_TARGET = str(project_root / 'data/Infrared')
...
cfg.TRAIN.BATCH_SIZE_SOURCE = 8
cfg.TRAIN.BATCH_SIZE_TARGET = 8
cfg.TRAIN.IGNORE_LABEL = 256
cfg.TRAIN.INPUT_SIZE_SOURCE = (256, 256)
cfg.TRAIN.INPUT_SIZE_TARGET = (256, 256)
# Class info
cfg.TRAIN.INFO_SOURCE = ''
cfg.TRAIN.INFO_TARGET = str(project_root / 'advent/dataset/infrared_list/info.json')
...
cfg.TRAIN.MAX_ITERS = 25000
cfg.TRAIN.EARLY_STOP = 25000
cfg.TRAIN.SAVE_PRED_EVERY = 2000
cfg.TRAIN.SNAPSHOT_DIR = ''
cfg.TRAIN.RANDOM_SEED = 1234
cfg.TRAIN.TENSORBOARD_LOGDIR = ''
cfg.TRAIN.TENSORBOARD_VIZRATE = 100 #每经历100此迭代，生成一次tensorboard可视化结果
...
cfg.TEST.SNAPSHOT_MAXITER = 1000  # used in 'best' mode
# Test sets
cfg.TEST.SET_TARGET = 'val'
cfg.TEST.BATCH_SIZE_TARGET = 4
cfg.TEST.INPUT_SIZE_TARGET = (256, 256)
cfg.TEST.OUTPUT_SIZE_TARGET = (256, 256)
cfg.TEST.INFO_TARGET = str(project_root / 'advent/dataset/infrared_list/info.json')
